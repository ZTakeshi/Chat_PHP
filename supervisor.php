<?php
  ...
  require_once('navegacao/blocked.php');
	...
	error_reporting(0);
  	...
  	if ($parametro)
  	{
    	...
    	$information = mysqli_query($conexao, "SELECT * FROM superuser where 1");

  	}else
  	{

    	$information = mysqli_query($conexao, "SELECT * FROM superuser order by nome");
...
<head>
  ...
  <title>Sistema de chat - Brisanet/Supervisor</title>
  ...
  <div id="wrapper">
    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item active">
        ...
        <a class="nav-link" href="<?php echo "users/dados.php?id=" . $chat->dados_super($_SESSION['admin'], 'id') . "&nome=" . $chat->dados_super($_SESSION['admin'], 'nome') . "&email=" . $chat->dados_super($_SESSION['admin'], 'email') . "&setor=" . $chat->dados_super($_SESSION['admin'], 'setor') . "&admin=" . $chat->dados_super($_SESSION['admin'], 'admin') . "&senha=" . $chat->dados_super($_SESSION['admin'], 'senha');?>">
      ...
      <li class="nav-item active">
        ...
        <a class="nav-link" href="#" data-toggle="modal" data-target="#mensagemModal">
      ...
      <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modalSuper">
      ...
      <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <a class="dropdown-item" href="users/tabela.php">
...
<!--           <a class="dropdown-item" href="#" data-toggle="modal" data-target="#exampleModalScrollable">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <!-- Tabela supervisores cadastrados -->
        <div class="card mb-3">
          ...
          <div class="type_msg">
            ...
            <div class="input_msg_write">
              ...
              <form method="POST" enctype="multipart/form-data">
                ...
                <input type="text" class="" name="msg" id="msg" autocomplete="off" wrap="hard" placeholder="Digite sua mensagem..." />
          ...
          <div class="form-group row">
              ...
              <div class="col-sm-10">
                ...
                <div class="input-group mb-3">
                  ...
                  <input type="password" class="form-control text-dark" name="senha" id="senhas" placeholder="**********" required="">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              ...
              <p>
                ...
                <input type="text" class="form-control" name="admin" id="inputAdmin3" placeholder="Usuário..." required>
