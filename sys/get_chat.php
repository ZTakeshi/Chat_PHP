		 	...
		 	if($dados['id_de'] != $_SESSION['usuario'])
		 	{
			 	...
			 	"<div class='incoming_msg'>
	      			...
	      			<div class='incoming_msg_img'> 
	      				...
	      				<img src='{$chat->dados_user($dados['id_de'],'foto')}' alt='sunil'> 
	      			...
	      			<div class='received_msg'>
	        			...
	        			<div class='received_withd_msg'>
	          				...
	          				<p>{$dados['mensagem']}</p>
	          				<span class='time_date'> {$chat->diferencia_datas($dados['data'])}</span>
	          			</div>
		...
		}else
		{
    		...
    		"<div class='outgoing_msg'>
      			...
      			<div class='sent_msg'>
        			...
        			<p>{$dados['mensagem']}</p>
        			<span class='time_date'>{$lido} {$chat->diferencia_datas($dados['data'])}</span> 
